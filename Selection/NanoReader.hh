...
public :
   ...
   Float_t         FatJet_tau10[10];   //[nFatJet]
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[107];   //[nGenPart]
   Float_t         GenPart_mass[107];   //[nGenPart]
   Float_t         GenPart_phi[107];   //[nGenPart]
   Float_t         GenPart_pt[107];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[107];   //[nGenPart]
   Int_t           GenPart_pdgId[107];   //[nGenPart]
   Int_t           GenPart_status[107];   //[nGenPart]
   ...
   Float_t         Tau_footprintCorr[15];   //[nTau]
   ...
   Float_t         Tau_rawMVAnewDM[15];   //[nTau]
   Float_t         Tau_rawMVAoldDM[15];   //[nTau]
   Float_t         Tau_rawMVAoldDMdR03[15];   //[nTau]
   ...
   UChar_t         Tau_idMVAnewDM[15];   //[nTau]
   UChar_t         Tau_idMVAoldDM[15];   //[nTau]
   UChar_t         Tau_idMVAoldDMdR03[15];   //[nTau]
   Float_t         TkMET_phi;
   Float_t         TkMET_pt;
   Float_t         TkMET_sumEt;
   UInt_t          nTrigObj;
